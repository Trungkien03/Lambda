...
import useRefundBookingStatusViewModel from "../../viewmodels/useRefundBookingStatusViewModel";
import BookingStatusItem from "../components/BookingStatusItem";

const RefundBookingStatus = () => {
  const theme = useTheme() as ThemeType;
  const { bookings } = useAppSelector((state) => state.bookingStatusView);

  useRefundBookingStatusViewModel();
...
export default RefundBookingStatus;
