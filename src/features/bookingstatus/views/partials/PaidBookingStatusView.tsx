...
import usePaidBookingStatusViewModel from "../../viewmodels/usePaidBookingStatusViewModel";
import BookingStatusItem from "../components/BookingStatusItem";

const PaidBookingStatusView = () => {
  ...
  return (
    <VStack flex={1} padding={4} bg={theme.colors.background}>
      ...
      {isSelectMode && selectedBookings.length > 0 && (
        <AppButton
          title={`View Details (${selectedBookings.length} items)`}
...
export default PaidBookingStatusView;
